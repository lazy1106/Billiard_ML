...
export class AbstractSeries<T> extends React.PureComponent<T> {}
...
export class Hint<T = any> extends React.PureComponent<HintProps & T> {}
...
export class ChartLabel<T = any> extends React.PureComponent<ChartLabelProps & T> {}
...
export class Borders<T = any> extends React.PureComponent<BordersProps & T> {}
...
export class Crosshair<T = any> extends React.PureComponent<CrosshairProps & T> {}
...
export class XYPlot<T = any> extends React.Component<XYPlotProps & T> {}
...
export class CircularGridLines<T = any> extends React.PureComponent<CircularGridLinesProps & T> {}
...
export class GridLines<T = any> extends React.PureComponent<GridLinesProps & T> {}

export interface GradientDefsProps {
    className?: string | undefined; // default: ''
}
export class GradientDefs<T = any> extends React.PureComponent<GradientDefsProps & T> {}
...
export class Treemap<T = any> extends React.Component<TreemapProps & T> {}
...
export class RadialChart<T = any> extends React.Component<RadialChartProps & T> {}
...
export class RadarChart<T = any> extends React.Component<RadarChartProps & T> {}
...
export class ParallelCoordinates<T = any> extends React.Component<ParallelCoordinatesProps & T> {}
...
export class Sankey<T = any> extends React.Component<SankeyProps & T> {}
...
export class Sunburst<T = any> extends React.Component<SunburstProps & T> {}
...
export class FlexibleXYPlot<T = any> extends React.Component<FlexibleXYPlotProps & T> {}
...
export class FlexibleWidthXYPlot<T = any> extends React.Component<FlexibleWidthXYPlotProps & T> {}
...
export class FlexibleHeightXYPlot<T = any> extends React.Component<FlexibleHeightXYPlotProps & T> {}
